...
## Deprecated: Rscript "$(dirname "$0")/CM21_R30_Compute_dark.R"           "ALL"

## Deprecated: info "Construct missing dark for S1"
## Deprecated: Rscript "$(dirname "$0")/CM21_R40_Missing_dark_construct.R" "ALL"

## Deprecated: info "Convert S1 to L0 GHI"
## Deprecated: Rscript "$(dirname "$0")/CM21_R50_Signal_to_GHI.R"          "ALL"
